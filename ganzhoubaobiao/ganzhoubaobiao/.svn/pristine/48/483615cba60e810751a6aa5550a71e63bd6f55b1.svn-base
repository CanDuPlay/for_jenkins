...
public class checkListDto implements Serializable {
	...
	private List<TSchoolInverted> invertedList;
	private List<scheduleListDto> scheduleList;
	private String reward;
	private String level;//1市级2区级3学校
	private Integer status;
	private Integer schedule;//学校当前进度
	private Integer tProjectStage;//当前阶段
	private Integer sort;
	private String zrdw;
	private String lxld;
	private String zfz;//市总负责人
	private String month;//市总负责人
	private Integer scheduleId;//学校当前进度id
	private Integer minStatus;//当前月份的最小状态
